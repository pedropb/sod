 ...
 */
Ext.define('GTPlanner.definitions.ImportFIDISDataPanel', {
	extend: 'Ext.panel.Panel',

	title: 'Importar definições (MAINFRAME, MATERA, VIEW)',
	...
	items: [{
		...
		items: [{
    		...
    		instructions: [
				'1 - Exporte os dados a partir dos sistemas MAINFRAME, MATERA e/ou VIEW',
				'2 - Observação: Não é necessário realizar a importação dos três arquivos simultaneamente',
    		...
    		labelWidth: 220,
    		width: 540,
    		fieldLabel: 'Arquivo de dados do MAINFRAME',
    		buttonText: 'Procurar...',
    		emptyText: 'Excel 97-2003 (.xls)',
    		name: 'import_file_mainframe',
    		allowBlank: true,
    		regex: /\.xls?$/,
    		regexText: 'O arquivo deve ter a extensão xls'
    	},{
    		xtype: 'filefield',
    		labelWidth: 220,
    		width: 540,
    		fieldLabel: 'Arquivo de dados MATERA',
    		buttonText: 'Procurar...',
    		emptyText: 'Excel 97-2003 (.xls)',
    		name: 'import_file_matera',
    		allowBlank: true,
    		regex: /\.xls?$/,
    		regexText: 'O arquivo deve ter a extensão xls'
    	},{
    		...
    		labelWidth: 220,
    		width: 540,
    		fieldLabel: 'Arquivo de dados VIEW',
    		buttonText: 'Procurar...',
    		emptyText: 'Excel 97-2003 (.xls)',
    		name: 'import_file_view',
    		allowBlank: true,
    		regex: /\.xls?$/,
    		regexText: 'O arquivo deve ter a extensão xls'
    	},{
