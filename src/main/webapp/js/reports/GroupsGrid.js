 ...
 */
Ext.define('GTPlanner.reports.GroupsGrid', {
	...
	tbar: [{
		...
		handler: function (btn) {
			...
			var store = Ext.create('Ext.ux.GTStore', GTPlanner.stores.groupsReportChart);
			...
			var win = Ext.create('Ext.window.Window', {
				title: 'Gráfico: Distribuição de Grupos por ' + groupBy + ' (09 maiores)',
				width: 800,
				height: 600,
				modal: true,
				layout: 'fit',
	...
	constructor: function (config) {
		...
		config = {
			store: Ext.create('Ext.ux.GTStore',	GTPlanner.stores.groupsReport)
		};
		...
		config.dblClickHandler = function () {
			...
			var store = Ext.create('Ext.ux.GTStore', GTPlanner.stores.groupsReport);
			store.getProxy().extraParams = {
				groupBy: groupBy,
